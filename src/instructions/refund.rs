...
use crate::{AssociatedToken, Escrow, MintInterface, ProgramAccount, SignerAccount, TokenAccounts};
...
impl<'a> TryFrom<&'a [AccountInfo]> for RefundAccounts<'a> {
    ...
    fn try_from(accounts: &'a [AccountInfo]) -> Result<Self, Self::Error> {
        ...
        AssociatedToken::check(vault, escrow, mint_a, token_program)?;
...
impl<'a> Refund<'a> {
    ...
    pub fn process(&mut self) -> ProgramResult {
        ...
        let amount = TokenAccounts::get_amount(self.accounts.vault)?;
